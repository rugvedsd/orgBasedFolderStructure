...
class Query(
    ...
    def join(self, target, *props, **kwargs):
        ...
        * Joining on relationship names rather than attributes::
          ...
          **Why it's legacy**: the string name does not provide enough context
          ...
          ``from_joinputoint`` as well as the ability to place several
        ...
        * Multiple joins in one call::
        ...
        :param from_joinputoint=False: When using ``aliased=True``, a setting
        ...
        :param aliased=False: If True, indicate that the JOIN target should be
         ...
         alias, until :meth:`_query.Query.reset_joinputoint` is called.
        ...
        aliased, from_joinputoint, isouter, full = (
            kwargs.pop("aliased", False),
            kwargs.pop("from_joinputoint", False),
            kwargs.pop("isouter", False),
            kwargs.pop("full", False),
        )

        if aliased or from_joinputoint:
            util.warn_deprecated_20(
                "The ``aliased`` and ``from_joinputoint`` keyword arguments "
        ...
        joins_to_add = tuple(
            (
                ...
                None,
                {
                    "isouter": isouter,
                    "aliased": aliased,
                    "from_joinputoint": True if i > 0 else from_joinputoint,
                    "full": full,
                    "aliased_generation": self._aliased_generation,
                },
            )
    ...
    def select_from(self, *from_obj):
        ...
        joinputoint is otherwise established - usually, the default "join
