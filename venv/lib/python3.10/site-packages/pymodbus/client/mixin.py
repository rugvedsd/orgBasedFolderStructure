...
class ModbusClientMixin(Generic[T]):  # pylint: disable=too-many-public-methods
    ...
    def read_coils(self, address: int, *, count: int = 1, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        """
        return self.execute(no_response_expected, pdu_bit.ReadCoilsRequest(address=address, count=count, dev_id=device_id))
    ...
    def read_discrete_inputs(self,
        ...
        """
        pdu = pdu_bit.ReadDiscreteinputsRequest(address=address, count=count, dev_id=device_id)
    ...
    def diag_read_device_busy_count(self, *, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        The response data field returns the quantity of messages addressed to the
        remote device for which it returned device Busy exception response,
    ...
    def diag_getclear_modbus_response(self, *, data: int = 0, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        them. Statistics are also cleared on power-up of the device,
        """
    ...
    def diag_get_comm_event_log(self, *, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        """
        return self.execute(no_response_expected, pdu_other_msg.GetCommEventLogRequest(dev_id=device_id))
    ...
    def write_coils(
        ...
        *,
        ...
        Coils are addressed as 0-N (Note some device manuals uses 1-N, assuming 1==0).
        """
        pdu = pdu_bit.WriteMultipleCoilsRequest(address=address, bits=values, dev_id=device_id)
        return self.execute(no_response_expected, pdu)
    ...
    def write_file_record(self, records: list[pdu_file_msg.FileRecord], *, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        bit words.
        """
        return self.execute(no_response_expected, pdu_file_msg.WriteFileRecordRequest(records=records, dev_id=device_id))
    ...
    def mask_write_register(
        ...
        *,
        ...
        """
        return self.execute(no_response_expected, pdu_reg.MaskWriteRegisterRequest(address=address, and_mask=and_mask, or_mask=or_mask, dev_id=device_id))
    ...
    def read_fifo_queue(self, *, address: int = 0x0000, device_id: int = 1, no_response_expected: bool = False) -> T:
        ...
        them.
        """
        return self.execute(no_response_expected, pdu_file_msg.ReadFifoQueueRequest(address, dev_id=device_id))
    ...
    def read_device_information(self, *, read_code: int | None = None,
        ...
        """
        return self.execute(no_response_expected, pdu_mei.ReadDeviceInformationRequest(read_code, object_id, dev_id=device_id))
