...
class Tag:
    ...
    returns `'pumpkin'`, the input should be validated as a `Pumpkinputie`.
    ...
    class ThanksgivingDinner(BaseModel):
        dessert: Annotated[
            Union[
                ...
                Annotated[Pumpkinputie, Tag('pumpkin')],
            ],
    ...
    '''
    ThanksgivingDinner(dessert=Pumpkinputie(time_to_cook=40, num_ingredients=6, filling='pumpkin'))
    '''
    ```
